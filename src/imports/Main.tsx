import svgPaths from "./svg-0y8azuqqfu";
...
import { imgVector, imgVector1, imgGroup, imgVector2 } from "./svg-04673";
...
export default function Main() {
  return (
    <div className="content-stretch flex flex-col gap-[199px] items-center justify-center relative size-full" data-name="Main">
      <HeaderHome />
      <SectionAbout />
      <SectionProjects />
      <SectionContact />
